...
public class PullToRefreshLoadMoreExpandableListView extends PullToRefreshExpandableListView implements ILoadMore,IListViewLoadMore {
	...
	public PullToRefreshLoadMoreExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		init();
	}
...
//                        ToastUtils.shortToast(mContext, R.string.lottery_no_network);
//                        return;
//                    }
		...
		this.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
			...
			public void onLastItemVisible() {
				if (mLoadingMoreLayout.getFooterState() == FooterState.LOADING ||
						...
						mLoadingMoreLayout.getFooterState() == FooterState.REACH_END_INVISIBLE) {
                    return;
                }
	...
	public void setReachEndInvisible() {
		mLoadingMoreLayout.setFootersState(FooterState.REACH_END_INVISIBLE);
	}
