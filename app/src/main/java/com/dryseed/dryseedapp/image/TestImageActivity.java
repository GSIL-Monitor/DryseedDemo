package com.dryseed.dryseedapp.image;
...
public class TestImageActivity extends BaseActivity implements OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.d("MMM", "Max memory is " + maxMemory + "KB"); //eg : mx5 is  Max memory is 98304KB

        setContentView(R.layout.activity_image_layout);
        initData();
        initView();
        mImageLoader = ImageLoader.build(TestImageActivity.this);
    }
