package com.dryseed.dryseedapp.framework.retrofit.demo2.adapter;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.MainViewHolder> {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_retrofit_adapter_item, parent, false);
