package com.dryseed.dryseedapp.canvas.bezier;
    ...
    public void onBezierShoppingCartViewClick(View view) {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int[] button1PointOnScreen = new int[2];
                int[] button1PointInWindow = new int[2];
                mButton1.getLocationOnScreen(button1PointOnScreen);
                mButton1.getLocationInWindow(button1PointInWindow);
                /*
                 ...
                 */
                LogUtil.d("getLocationOnScreen [x:%d][y:%d][getY:%.2f]", button1PointOnScreen[0], button1PointOnScreen[1], mButton1.getY());
                LogUtil.d("getLocationInWindow [x:%d][y:%d][getY:%.2f]", button1PointInWindow[0], button1PointInWindow[1], mButton1.getY());

                //生成商品View
                BezierShoppingCartView goodsView = new BezierShoppingCartView(TestBezierActivity.this);
                goodsView.setCircleStartPoint(goodsPointOnScreen[0], goodsPointOnScreen[1] - (int) shoppingCartLayout.getY());
                goodsView.setCircleEndPoint(
                        shoppingCartPointOnScreen[0] + DPIUtil.dip2px(40) / 2,
                        shoppingCartPointOnScreen[1] - (int) shoppingCartLayout.getY() - UIUtil.getStatusBarHeight(goodsView.getContext()));
