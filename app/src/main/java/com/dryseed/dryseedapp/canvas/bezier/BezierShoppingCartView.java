 ...
 * @author caiminming
 */
public class BezierShoppingCartView extends View {
    //小红点开始坐标
    ...
    public BezierShoppingCartView(Context context) {
        super(context);
        init(context);
    }

    public BezierShoppingCartView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BezierShoppingCartView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void startAnimation() {
        ...
        valueAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                viewGroup.removeView(BezierShoppingCartView.this);
            }
        });
        valueAnimator.start();
    }
