...
package com.dryseed.dryseedapp.lib.zxing.client.android.result;
...
import com.dryseed.dryseedapp.lib.zxing.client.android.Contents;
...
@SuppressLint("NewApi") public abstract class ResultHandler {
...
/**
  ...
  @SuppressLint("NewApi") final void addContact(String[] names,
                        String[] nicknames,
...
/**
  ...
  final void searchBookContents(String isbnOrUrl) {
    ...
    intent.setClassName(activity, SearchBookContents.class.getName());
...
/**
  ...
  @SuppressLint("NewApi") private static void putExtra(Intent intent, String key, String value) {
    if (value != null && !value.isEmpty()) {
      intent.putExtra(key, value);
    }
  }

  @SuppressLint("NewApi") private String parseCustomSearchURL() {
