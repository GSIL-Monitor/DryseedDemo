...
abstract public class MergedQueue implements JobSet {
    ...
    /**
     *
     * @param initialCapacity passed to {@link MergedQueue#createQueue(MergedQueue.SetId, int, Comparator)}
     * @param comparator passed to {@link MergedQueue#createQueue(MergedQueue.SetId, int, Comparator)}
