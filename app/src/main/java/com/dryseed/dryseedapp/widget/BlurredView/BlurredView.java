...
public class BlurredView extends RelativeLayout {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        if (null != drawable) {
            ...
            mBlurredBitmap = BlurBitmapUtil.blurBitmap(context, mOriginBitmap, 25f);
        }
    ...
    public void setBlurredImg(Bitmap blurredBitmap) {
        if (null != blurredBitmap) {
            ...
            mBlurredBitmap = BlurBitmapUtil.blurBitmap(mContext, blurredBitmap, 25f);
            setImageView();
    ...
    public void setBlurredImg(Drawable blurDrawable) {
        if (null != blurDrawable) {
            ...
            mBlurredBitmap = BlurBitmapUtil.blurBitmap(mContext, mOriginBitmap, 25f);
            setImageView();
            setMove(mContext, isMove);
        }
    }
