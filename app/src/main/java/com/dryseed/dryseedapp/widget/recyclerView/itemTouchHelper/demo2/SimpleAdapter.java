...
public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.SimpleHolder> {
    ...
    public SimpleAdapter(List<String> data, OnStartDragListener onStartDragListener) {
        this.mData = data;
    ...
    public SimpleHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_item_touch_helper_2_item, parent, false);
