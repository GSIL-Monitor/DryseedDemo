...
public class BlurBitmapUtil {
    ...
    public static Bitmap fastBlur(Bitmap sentBitmap, int radius) {
        return fastBlur(sentBitmap, radius, BITMAP_SCALE);
    }

    public static Bitmap fastBlur(Bitmap sentBitmap, int radius, float scale) {
        ...
        ToastUtil.showToast("cost : " + (System.currentTimeMillis() - timeStart) + "ms");
