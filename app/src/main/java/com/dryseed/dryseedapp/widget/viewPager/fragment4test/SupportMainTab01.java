...
public class SupportMainTab01 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final LinearLayout rootView = (LinearLayout) inflater.inflate(R.layout.activity_tab_viewpager_main_tab_01, container, false);
