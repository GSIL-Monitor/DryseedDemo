...
/**
 * 自定义AlertDialog,代替系统Dialog
 */
public class DsAlertDialog {
    ...
    private DsAlertDialog.Builder mBuilder;
    private View mView;
    ...
    public DsAlertDialog(Context context) {
        this.mContext = context;
    }


    public void show() {
        // 加上判断，解决线上对话框BadTokenException的问题
        if (mContext == null) {
            return;
        }
    ...
    public DsAlertDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public DsAlertDialog setContentView(View view) {
    ...
    public DsAlertDialog setContentView(int layoutResId) {
    ...
    public DsAlertDialog setBackground(Drawable drawable) {
    ...
    public DsAlertDialog setBackgroundResource(int resId) {
    ...
    public DsAlertDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public DsAlertDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public DsAlertDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public DsAlertDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public DsAlertDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        this.pId = resId;
    ...
    public DsAlertDialog setPositiveButton(String text, final View.OnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }
    ...
    public DsAlertDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
    ...
    public DsAlertDialog setNegativeButton(String text, final View.OnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }

    public DsAlertDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public DsAlertDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            mAlertDialogWindow.getAttributes().windowAnimations = 0;
            ...
            View contentView = LayoutInflater.from(mContext).inflate(R.layout.app_dialog_layout, null);
            ...
            //默认不显示，当添加确定按钮或取消按钮后才显示
            if (isNullOrEmpty(pText) && pId == -1 && isNullOrEmpty(nText) && nId == -1) {
