package com.dryseed.dryseedapp.widget.nestedScrolling.myNestScroll.view;
...
public class MyNestedScrollChild extends LinearLayout implements NestedScrollingChild {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("MMM", "showHeight : " + showHeight + " | heightMeasureSpec : " + heightMeasureSpec + " | getHeight : " + DPIUtil.getHeight());
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (startNestedScroll(ViewCompat.SCROLL_AXIS_VERTICAL) //如果找到了支持嵌套滚动的父类
                    ...
                    if (remain != 0) {
                        Log.d("MMM", "scrollBy(0, -remain);");
                        scrollBy(0, -remain);
                    }

                } else {
                    Log.d("MMM", "scrollBy(0, -dy); " + dy);
                    scrollBy(0, -dy);
                }
        }
