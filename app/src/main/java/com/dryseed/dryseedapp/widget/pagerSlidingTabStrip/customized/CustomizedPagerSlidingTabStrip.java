...
public class CustomizedPagerSlidingTabStrip extends LinearLayout {
    /**
     * 绘制三角形的画笔
     */
    ...
    public CustomizedPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public CustomizedPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        super(context, attrs);

        // 获得自定义属性，tab的数量
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CustomizedPagerSlidingTabStrip);
        mTabVisibleCount = a.getInt(R.styleable.CustomizedPagerSlidingTabStrip_itemCount, COUNT_DEFAULT_TAB);
