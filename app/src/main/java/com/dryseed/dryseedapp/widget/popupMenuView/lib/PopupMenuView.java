package com.dryseed.dryseedapp.widget.popupMenuView.lib;
...
public class PopupMenuView extends PopupView implements OptionMenuView.OnOptionMenuClickListener {
    ...
    public void setDividerDrawable(@LinearLayoutCompat.DividerMode int showDividers, Drawable divider){
        mOptionMenuView.setShowDividers(showDividers);
        mOptionMenuView.setDividerDrawable(divider);
    }
