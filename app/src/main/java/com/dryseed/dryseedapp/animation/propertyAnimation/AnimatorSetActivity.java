...
public class AnimatorSetActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animation_animator_set_layout);
...
//		animSet.playSequentially(items)
    ...
    public void playWithAfter(View view) {
         ...
         * 比如	animSet.play(anim1).with(anim2).before(anim3).before(anim5); 这样是不行的，系统不会根据你写的这一长串来决定先后的顺序，所以麻烦你按照上面例子的写法，多写几行
         */
        AnimatorSet animSet = new AnimatorSet();
