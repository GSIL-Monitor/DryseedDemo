...
import com.dryseed.dryseedapp.customView.gestureLock.GestureLockView.Mode;
 ...
 * 得：mGestureLockViewWidth = 4 * mWidth / ( 5 * mCount + 1 ) 注：mMarginBetweenLockView = mGestureLockViewWidth * 0.25 ;
 *
 * @author zhy
 */
