package com.dryseed.dryseedapp.customView.guaguaka;
...
public class GuaGuaKaView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCanvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.s_title), null, new RectF(0, 0, width, height), null);
    }
